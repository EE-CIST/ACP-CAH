---
title: "Cours 2 : Principes de l'analyse factorielle (ex. de l'ACP)"
...
-   **N.B. Cette introduction à l'ACP est directement adaptée du chapitre 10 de @denis2020, pp. **
...
## Principes statistiques de l'ACP
...
kable(acp.data, caption = "Données", row.names = T)
```
