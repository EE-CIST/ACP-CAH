---
title: "TD d'application de l'ACP et la CAH"
...
L'objectif de ce document est de présenter une première approche **non technique** des méthodes d'analyse factorielle et de classification. Il s'agit donc de faire saisir les objectifs des deux méthodes que l'on peut résumer en première analyse comme suit :
